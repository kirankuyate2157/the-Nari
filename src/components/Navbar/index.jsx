...
function Navbar() {
  function profImg(image) {
    return (
      <>
        <div className='bg-transparent w-full text-4xl '>
          <img src={image} alt='user profile ' className='rounded-full' />
        </div>
      </>
    );
  }
  ...
  const Pf = () => {
    if (usr.photoURL) return profImg(usr.photoURL);
    else return <CgProfile className='bg-transparent w-full text-4xl ' />;
  };
      ...
      <div className='md:px-20 px-6 flex flex-row bg-white  shadow-2xl justify-between'>
        <div className=' flex items-center bg-white   align-center'>
          <div className='  items-center flex bg-white flex-row justify-center bg-transparent   gap-3 '>
            ...
            <div>
              <img src={nariName} alt='nari logo' className='h-8 bg-white' />
            </div>
          </div>
        </div>
        ...
        <div className=' flex items-center bg-white flex-row justify-end gap-5  w-full'>
          ...
          <div>
            <span className='w-full md:hidden '>
              <BiMenu className='bg-transparent w-full text-lg  ' />
            </span>
          </div>
          <div className=' flex items-center flex-col bg-white justify-center align-middle   '>
            <ul className=' flex items-center flex-row gap-3 justify-evenly  bg-white w-full '>
              <li className='w-full bg-white text-red-600 '>
                <BiCurrentLocation className='bg-transparent w-full text-2xl  ' />
              </li>
              <li className='w-full bg-white '>
                <AiOutlineSetting className='bg-transparent w-full text-2xl ' />
              </li>
              <li className='w-full bg-white '>
                <IoMdNotificationsOutline className='bg-transparent w-full text-2xl ' />
              </li>
              <li className='w-full bg-white mx-2'>
                <Pf />
              </li>
            </ul>
          </div>
